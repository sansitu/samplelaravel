...
@section('breadcrum', 'Manage Employee')
@section('employeeActive','actives')
									...
									if (!checkcontactno($("#txtprimaryno").val())) {
										...
										output = false;
											...
											if (($("#txtalternateno").val() != "") && (!checkcontactno($("#txtalternateno").val())))  {
												...
												if (($("#txtpassword").val() == "") && ($('#addEmployee').text() != "Update")) {
										
													alert('Enter the password');
													output = false;
												} else {
													
													if (($("#txtrpassword").val() == "") && ($('#addEmployee').text() != "Update")) {
														...
														if ($("#txtpassword").val() != $("#txtrpassword").val()) {
															...
															alert('Password & Retype password does not match');
															output = false;
														}
													}	
												}
